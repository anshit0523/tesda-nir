...
/* optional: stagger so cards don't all zoom in unison */
.news-slide:nth-child(2) { animation-delay: 0.3s; }
.news-slide:nth-child(3) { animation-delay: 0.6s; }
.news-slide:nth-child(4) { animation-delay: 0.9s; }
.news-slide:nth-child(5) { animation-delay: 1.2s; }
.news-slide:nth-child(6) { animation-delay: 1.5s; }
</style>
   ...
   <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
         ...
         <div class="flex items-center gap-3">
            ...
            <button id="newsPrev" type="button" aria-label="Previous news"
               class="flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-blue-800 shadow-sm transition hover:bg-blue-900 hover:text-white disabled:cursor-not-allowed disabled:opacity-40">
            ...
            <button id="newsNext" type="button" aria-label="Next news"
               class="flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-blue-800 shadow-sm transition hover:bg-blue-900 hover:text-white disabled:cursor-not-allowed disabled:opacity-40">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                  stroke="currentColor" class="h-5 w-5">
      ...
      <div class="relative mt-12 overflow-hidden">
         ...
         <div id="newsTrack" class="flex transition-transform duration-500 ease-out">
            ...
            <article class="news-slide w-full shrink-0 px-2 sm:w-1/2 lg:w-1/3">
               ...
               <div
                  class="group h-full overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-100 transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                  ...
                  <div class="p-6">
                     ...
                     <a href="https://web.facebook.com/photo?fbid=122172124520960562&set=a.122113477226960562"
            ...
            <article class="news-slide w-full shrink-0 px-2 sm:w-1/2 lg:w-1/3">
               ...
               <div
                  ...
                  <div class="p-6">
                     ...
                     <a href="https://web.facebook.com/NegOcc.Gov/posts/pfbid02pgFZpV3kjppX1hvxXiKmnzURuFyBJ5p6RZRgtdTbtiBozM5UbfHtjZyYCyQnCixkl"
                        class="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-blue-700 hover:text-blue-900">
                        Read more
            ...
            <article class="news-slide w-full shrink-0 px-2 sm:w-1/2 lg:w-1/3">
               ...
               <div
                  ...
                  <div class="p-6">
                     ...
                     <a href="https://web.facebook.com/OfficialTESDANIR/posts/pfbid029fXZVQhFrHkoNQDJrAkhw4ibf1XM5satbkMFLM6fgBiYkeLxjUx7ysJEfW9zVjjol"
                        class="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-blue-700 hover:text-blue-900">
                        Read more
            ...
            <article class="news-slide w-full shrink-0 px-2 sm:w-1/2 lg:w-1/3">
               ...
               <div
                  ...
                  <div class="p-6">
                     ...
                     <a href="https://web.facebook.com/OfficialTESDANIR/posts/pfbid0saSFNabk2C7G2kUyGkmn22uLKXpMDt192K3iyUPwyZEZZKLUbcL8Przmw1apNKaVl"
                        class="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-blue-700 hover:text-blue-900">
                        Read more
            ...
            <article class="news-slide w-full shrink-0 px-2 sm:w-1/2 lg:w-1/3">
               ...
               <div
                  ...
                  <div class="relative h-56 overflow-hidden bg-gray-200">
                     ...
                     <img src="{{ asset('images/news/news-5.jpg') }}" alt="TESDA NIR News"
                        class="h-full w-full object-cover transition duration-500 group-hover:scale-105">
            ...
            <article class="news-slide w-full shrink-0 px-2 sm:w-1/2 lg:w-1/3">
               ...
               <div
                  ...
                  <div class="relative h-56 overflow-hidden bg-gray-200">
                     ...
                     <img src="{{ asset('images/news/news-6.jpg') }}" alt="TESDA NIR News"
                        class="h-full w-full object-cover transition duration-500 group-hover:scale-105">
      ...
      {{-- Dots --}}
      <div id="newsDots" class="mt-8 flex justify-center gap-2"></div>
      ...
      <div class="mt-8 text-center">
         ...
         <a href="#"
            class="inline-flex items-center gap-2 rounded-xl bg-blue-900 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-800 hover:shadow-md">
            View All News
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  let originals = Array.from(track.querySelectorAll('.news-slide'));
  ...
  function buildClones() {
    clearClones();
    originals = Array.from(track.querySelectorAll('.news-slide')).slice(0, originalCount);
    ...
    for (let i = 0; i < CLONE_COUNT; i++) {
      const clone = originals[originalCount - 1 - i].cloneNode(true);
      clone.dataset.clone = 'true';
  ...
  function getMaxIndexOriginal() {
    return Math.max(0, originalCount - getSlidesPerView());
  }

  function updateDots() {
    const dots = dotsContainer.querySelectorAll('button');
    dots.forEach((dot, i) => {
      dot.className = i === (currentIndex - CLONE_COUNT)
  ...
  function createDots() {
    ...
    const total = getMaxIndexOriginal() + 1;
  ...
  function updateCarousel(animate = true) {
    ...
    prevButton.disabled = (currentIndex === CLONE_COUNT);
    nextButton.disabled = (currentIndex >= CLONE_COUNT + getMaxIndexOriginal());
    updateDots();
  }

  track.addEventListener('transitionend', () => {
    const maxOriginalStart = CLONE_COUNT + getMaxIndexOriginal();
    if (currentIndex > maxOriginalStart) {
      ...
      track.style.transition = 'none';
      currentIndex = CLONE_COUNT + getMaxIndexOriginal();
      updateCarousel(false);
      requestAnimationFrame(() => track.style.transition = '');
    }
  });
