...
<li class="relative group">
    ...
    <!-- Button -->
    <button type="button" class="flex items-center gap-2 py-2 transition duration-300 hover:text-amber-300">
    ...
    <div class="absolute left-0 top-full pt-3 w-72
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-xl overflow-hidden">
            ...
            <a href="{{ url('/organizational-structure') }}"
                class="block px-6 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-900 transition">
