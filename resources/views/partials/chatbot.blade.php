...
<div id="tesdaChatbot" class="fixed bottom-5 right-5 sm:bottom-7 sm:right-7 z-[9999] font-['Frutiger',sans-serif]">
    ...
    >
        ...
        {{-- Gold Dot Badge --}}
        <span id="chatbotNotification" class="absolute -right-1 -top-1 flex h-3.5 w-3.5 items-center justify-center rounded-full border-2 bg-green-500 shadow-sm"></span>
    </button>
